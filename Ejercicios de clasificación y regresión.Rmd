---
title: "Ejercicios de clasificación y regresión"
...
theta = GD(xtrain,ytrain,theta,lambda,num_iteraciones = 3000 ) # Al ser única ejecución podemos subirle el número de iteraciones
```
...
Como vemos, el error está acorde a lo esperado.
